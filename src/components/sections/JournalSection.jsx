        ...
        <div className="mt-[4rem] grid gap-[6rem] md:mt-[10rem] md:gap-0 md:border-b md:border-ink/10">
          {journal.posts.map((post, index) => (
            <Reveal key={post.title} delay={index * 0.06}>
              <article className="md:border-t md:border-ink/10 md:py-[3rem]">
                <div className="grid gap-[3rem] md:grid-cols-[auto_97.6rem]">
                  <div className="md:order-2">
                    <Link
                      href={post.href}
                      className="group relative mx-[-2rem] block aspect-[365/250] overflow-hidden md:mx-0 md:aspect-[976/450]"
                    >
